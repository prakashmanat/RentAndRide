                  ...
                  <tbody>
                    <tr>
                      ...
                      ?>
                        ...
                        <td align="center"><button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#edit"><i class="fa fa-pencil"></i></button>
                          <button type="button" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></button>
                          <button type="button" style="background-color: #c3039e;" class="btn btn-sm"><i class="fa fa-eye" style="color: white"></i></button>
                        </td>
                    </tr>
                  <?php } ?>
                  </tbody>
